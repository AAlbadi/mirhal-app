...
// On Render/cloud: frontend is served by Vercel, so no static file serving needed here.
// Only serve static files if a public_html directory exists (cPanel legacy support).
...
if (fs.existsSync(publicHtmlPath)) {
  app.use((req, res, next) => {
    ...
    express.static(publicHtmlPath)(req, res, next);
  });
  app.get(/^(?!\/api).+/, (req, res) => {
