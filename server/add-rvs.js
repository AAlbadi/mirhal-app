...
require('dotenv').config({ path: '/Users/aziz/Downloads/mirhal-–-peer-to-peer-rv-&-camper-marketplace/server/.env' });
...
async function addRVs() {
  try {
    ...
    const listings = rvListings.map(rv => ({ ...rv, hostId: host._id }));
